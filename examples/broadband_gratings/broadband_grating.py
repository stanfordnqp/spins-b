"""2D fiber-to-chip broadband grating coupler optimization code.
...
$ python3 broadband_gratings.py run save-folder

To view results:
$ python3 broadband_gratings.py view save-folder

To see optimization status quickly:
$ python3 broadband_gratings.py view_quick save-folder

To resume an optimization:
$ python3 broadband_gratings.py resume save-folder

To generate a GDS file of the grating:
$ python3 broadband_gratings.py gen_gds save-folder
"""
import os
import pickle
import shutil
